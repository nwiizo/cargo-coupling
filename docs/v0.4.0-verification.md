...
The release tag points to `d3fe7b8f29e70d53201cae0ce0d409ef625b8772`.
[CI](https://github.com/nwiizo/cargo-coupling/actions/runs/34231637660) passed all
eight jobs, including Linux/macOS/Windows release builds and self-analysis.
[RustSec audit](https://github.com/nwiizo/cargo-coupling/actions/runs/34231637527)
also passed. The
[release workflow](https://github.com/nwiizo/cargo-coupling/actions/runs/34232159233)
successfully published to crates.io and created the
[GitHub Release](https://github.com/nwiizo/cargo-coupling/releases/tag/v0.4.0)
on 2026-09-08 at 13:29 UTC. Issue #86 is closed.

The actual registry package was then downloaded and installed separately:

```bash
cargo install cargo-coupling --version 0.4.0 --locked \
  --root /tmp/coupling-v040-verification
```

Its executable reports version 0.4.0. Through Cargo subcommand lookup it analyzes
the real similarity-rs `src` directory as six files/six modules. Its design JSON
reports analyzer 0.4.0, scoring method `khononov-compensation-v2`, JSON schema 2
and design schema 1, with the supplied scenario and retained decision present.
Self-analysis still reports grade A, zero High/Critical and 44 Medium findings.
TODO 26 is complete; this publication record was added after the immutable
release tag, without changing the released implementation.
